...
/**
 * aux_sort - creates a tree using the half element of the array
...
/**
 * sorted_array_to_avl - creates an alv tree from an array
 * @array: array to be converted
 * @size: number of elements in the array
 * Return: the created alv tree or NULL on failure
 */
